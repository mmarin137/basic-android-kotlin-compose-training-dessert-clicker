    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = {
                ...
                val revenue = dessertUiState.revenue + dessertUiState.currentDessertPrice
                val dessertsSold = dessertUiState.dessertsSold + 1

                // Show the next dessert
                val dessertToShow = determineDessertToShow(desserts, dessertsSold)
                val currentDessertImageId = dessertToShow.imageId
                val currentDessertPrice = dessertToShow.price

                dessertViewModel.updateRevenueAndDessertData(
                    revenue = revenue,
                    dessertsSold = dessertsSold,
                    dessertImageId = currentDessertImageId,
                    dessertPrice = currentDessertPrice
                )
